...
- **Operators** — Add, subtract, multiply, divide, percent. Tap the operator to open a menu and change it; each operator has a distinct color (e.g. orange for minus, blue for multiply).
